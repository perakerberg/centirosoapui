...
package centiro.soapui.teststeps;

public class IconFileNames {
    public static final String READ_FILE = "readfile.png";
    public static final String WRITE_FILE = "writefile.png";
    public static final String TRANSFORM_TEXT = "transformtext.png";
    ...
    public static final String TRANSFORM_TEXT_ERROR = "transformtext-error.png";
    ...
    public static final String TRANSFORM_TEXT_OK = "transformtext-ok.png";
